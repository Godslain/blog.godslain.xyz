...
|2      | AE, ae          | Aedir (...)<br>Pronounced as "a" followed by "e" in two distinct syllables.<br>Diphthong or hiatus [a.e], depending on speaker articulation. | <span class="runes">Æ</span> |
...
| 27     | P, p          | The p in pat.<br>Voiceless bilabial stop [p].                                                                                                |   <span class="runes">p</span>    |
